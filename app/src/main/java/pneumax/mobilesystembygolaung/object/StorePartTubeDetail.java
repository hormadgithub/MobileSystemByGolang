...
public class StorePartTubeDetail implements Parcelable {
    ...
    public StorePartTubeDetail() {
    }

    protected StorePartTubeDetail(Parcel in) {
    ...
    public static final Creator<StorePartTubeDetail> CREATOR = new Creator<StorePartTubeDetail>() {
        @Override
        public StorePartTubeDetail createFromParcel(Parcel source) {
            return new StorePartTubeDetail(source);
        }

        @Override
        public StorePartTubeDetail[] newArray(int size) {
            return new StorePartTubeDetail[size];
        }
    };
}
