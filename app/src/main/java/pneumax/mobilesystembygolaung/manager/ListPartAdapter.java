...
public class ListPartAdapter extends BaseAdapter {

    private Context context;
    private String[] arrListPartNid;
    private String[] arrDescripiton;

    public ListPartAdapter(Context context,
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View view1 = layoutInflater.inflate(R.layout.listpartdata, viewGroup, false);
